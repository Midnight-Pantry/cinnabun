...
function Template({ children }) {
  return /* @__PURE__ */ h(fragment, null, /* @__PURE__ */ h("head", null, /* @__PURE__ */ h("meta", { charSet: "UTF-8" }), /* @__PURE__ */ h("meta", { name: "viewport", content: "width=device-width, initial-scale=1.0" }), /* @__PURE__ */ h("title", null, "My App")), /* @__PURE__ */ h("body", null, ...children));
}
